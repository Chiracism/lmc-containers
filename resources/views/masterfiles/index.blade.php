...
<!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Master Files</h1>
    ...
    <div class="row">
        <div class="card mx-auto">
            ...
            <div class="card-header">
                <div class="row">
                    <div class="col">
                        <form method="GET" action="{{ route('masterfiles.index') }}">
                    ...
                    <div>
                        <a href="{{ route('masterfiles.create')}}" class="btn btn-primary float-right">Add</a>
                    </div>
                </div>
            </div>
            {{-- <div class="row"> --}}
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="{{ route('masterfiles.edit', $masterfile->id)}}" class="btn btn-success">Edit</a></td>
                            </tr>    
                            @endforeach
                        </tbody>
                    </table>
