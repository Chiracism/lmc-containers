...
<!-- Page Heading -->
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Add Pays') }}
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('pays.store') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="pays_id" type="text" class="form-control @error('pays_id') is-invalid @enderror" name="pays_id" value="{{ old('pays_id') }}" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="pays_name" type="pays_name" class="form-control @error('pays_name') is-invalid @enderror" name="pays_name" value="{{ old('pays_name') }}" required>
