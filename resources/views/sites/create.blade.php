                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('sites.store') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="site_id" type="text" class="form-control @error('site_id') is-invalid @enderror" name="site_id" value="{{ old('site_id') }}" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="site_name" type="site_name" class="form-control @error('site_name') is-invalid @enderror" name="site_name" value="{{ old('site_name') }}" required>
