        ...
        <div class="card mx-auto">
            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div>
                        <a href="{{ route('sizes.create')}}" class="btn btn-primary float-right">Add</a>
                    </div>
                </div>
            </div>
            {{-- <div class="row"> --}}
                <div class="card-body">
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <th scope="col">Taille de Conteneur</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="{{ route('sizes.edit', $size->id)}}" class="btn btn-success">Edit</a></td>
                            </tr>    
                            @endforeach
                        </tbody>
                    </table>
