...
<!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Update Sous-Site</h1>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('sous_sites.update',$sous_site->id) }}">
                            @csrf
                            @method('put')
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                  <select id ="site_id" name="site_id" class="form-control" aria-label="Default select example">
                                    ...
                                    <option value="{{ $site->site_id }}" {{ $site->site_id == $sous_site->site_id ? 'selected' : ''}}>{{ $site->site_id }}</option>
                                    @endforeach
                                  </select>
                                    @error('site_id')
