...
<!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800"> Surestarie </h1>
    ...
    <div class="row">
        <div class="card mx-auto">
            ...
            <div class="card-header">
                <div class="row">
                    <div class="col">
                        <form method="GET" action="{{ route('surestaries.index') }}">
                    ...
                    <div>
                        <a href="{{ route('surestaries.create')}}" class="btn btn-primary float-right">Add</a>
                    </div>
                </div>
            </div>
            {{-- <div class="row"> --}}
